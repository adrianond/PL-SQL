-- Pipeline Functions - retorna um registro por vez sem a necessidade de criar collections - melhor performance
...
SELECT * FROM TABLE(FNC_FETCH_EMPLOYEES_TABLE_PIPELINE(60));
